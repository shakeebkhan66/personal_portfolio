...
class PhysicsTutors extends StatefulWidget {
  const PhysicsTutors({Key? key}) : super(key: key);

  @override
  State<PhysicsTutors> createState() => _PhysicsTutorsState();
}

class _PhysicsTutorsState extends State<PhysicsTutors> {
  @override
        ...
        child: Padding(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                .where('selectedSubject', isEqualTo: "Physics")
                .snapshots(),
            builder:
