...
class ComputerTutors extends StatefulWidget {
  const ComputerTutors({Key? key}) : super(key: key);

  @override
  State<ComputerTutors> createState() => _ComputerTutorsState();
}

class _ComputerTutorsState extends State<ComputerTutors> {
  @override
        ...
        child: Padding(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                .where('selectedSubject', isEqualTo: "Computer")
                .snapshots(),
            builder:
