...
class MathsTutors extends StatefulWidget {
  const MathsTutors({Key? key}) : super(key: key);

  @override
  State<MathsTutors> createState() => _MathsTutorsState();
}

class _MathsTutorsState extends State<MathsTutors> {
  @override
        ...
        child: Padding(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                .where('selectedSubject', isEqualTo: "Mathematics")
                .snapshots(),
            builder:
