...
class BiologyTutors extends StatefulWidget {
  const BiologyTutors({Key? key}) : super(key: key);

  @override
  State<BiologyTutors> createState() => _BiologyTutorsState();
}

class _BiologyTutorsState extends State<BiologyTutors> {
  @override
        ...
        child: Padding(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                .where('selectedSubject', isEqualTo: "Biology")
                .snapshots(),
            builder:
