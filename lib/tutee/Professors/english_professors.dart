...
class EnglishTutors extends StatefulWidget {
  const EnglishTutors({Key? key}) : super(key: key);

  @override
  State<EnglishTutors> createState() => _EnglishTutorsState();
}

class _EnglishTutorsState extends State<EnglishTutors> {
  @override
        ...
        child: Padding(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                .where('selectedSubject', isEqualTo: "English")
                .snapshots(),
            builder:
