...
class PythonTutors extends StatefulWidget {
  const PythonTutors({Key? key}) : super(key: key);

  @override
  State<PythonTutors> createState() => _PythonTutorsState();
}

class _PythonTutorsState extends State<PythonTutors> {
  @override
        ...
        child: Padding(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                .where('selectedSubject', isEqualTo: "Python")
                .snapshots(),
            builder:
