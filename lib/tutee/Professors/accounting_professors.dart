...
class AccountingTutors extends StatefulWidget {
  const AccountingTutors({Key? key}) : super(key: key);

  @override
  State<AccountingTutors> createState() => _AccountingTutorsState();
}

class _AccountingTutorsState extends State<AccountingTutors> {
  @override
        ...
        child: Padding(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                .where('selectedSubject', isEqualTo: "Accounting")
                .snapshots(),
            builder:
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (ctx) => const TutorProfileScreen()));
                        },
                        child: Container(
                          margin: const EdgeInsets.symmetric(horizontal: 7.0),
                          width: MediaQuery.of(context).size.width,
