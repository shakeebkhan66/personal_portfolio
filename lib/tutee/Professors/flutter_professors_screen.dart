...
class FlutterTutors extends StatefulWidget {
  const FlutterTutors({Key? key}) : super(key: key);

  @override
  State<FlutterTutors> createState() => _FlutterTutorsState();
}

class _FlutterTutorsState extends State<FlutterTutors> {
  @override
        ...
        child: Padding(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                .where('selectedSubject', isEqualTo: "Flutter")
                .snapshots(),
            builder:
